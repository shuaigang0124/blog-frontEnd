 ...
 *
 * 参与者:
 *    Andrew Banks—初始API和实现以及初始文档
 *******************************************************************************/


//在全局命名空间中只公开一个对象名称。
//所有东西都必须经过这个模块。全球泛美卫生组织。MQTT模块
//只有一个公共函数client，它返回
// a Paho。给定连接详细信息的MQTT客户机对象。
...
Paho.MQTT = (function(global) {
    ...
    /*
     * Websockets MQTT V3.1客户端的内部实现。
     * 
     * @name Paho.MQTT.ClientImpl @constructor 
     * @param {String} host webSocket主机的DNS名称。 
     * @param {Number} port 该主机的端口号。
     * @param {String} clientId MQ客户端标识符。
     */
