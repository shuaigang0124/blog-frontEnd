<template>
  <form>
    ...
    <div class="inputGroup inputGroup1" @keydown="keydown($event)">
      <label for="loginEmail" id="loginEmailLabel">Email</label>
      <input type="email" id="loginEmail" maxlength="254" />
      <p class="helper helper1">email@qq.com</p>
    </div>
    <div class="inputGroup inputGroup2" @keydown="keydown($event)">
    ...
    <div class="inputGroup inputGroup3">
      <button type="button" id="login" @click="goLogin">Log in</button>
    </div>
    <div class="bottom_info">
      ...
      <div>
        <!-- href="../register" -->
        <a style="color: #4eb8dd" @click="msg()">没有账号？去注册</a>
      </div>
    </div>
  </form>
</template>
